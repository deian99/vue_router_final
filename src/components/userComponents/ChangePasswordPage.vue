  ...
  <div class="wrapper">
    <form method="post">
      <div class="container">
        ...
        <br />
        <p>Please type in your account's username and change your password.</p>
        <br />
        ...
        <button @click.prevent="changePassword1" class="btn">
          Recover Password
        </button>
        <br /><br />
      </div>
...
export default {
  ...
  methods: {
    ...
    changePassword() {
      ...
      if (data === null) {
        this.message = "Username does not exist. Please register first.";
        h3.style.color = "red";
      } else {
